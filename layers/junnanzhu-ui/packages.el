...
(defconst junnanzhu-ui-packages
  '(
    (junnan-mode-line :location built-in)
    diminish
    popwin
    (whitespace :location built-in)
    ;; hl-anything performance is very slow...
    ;; hl-anything
    ;; if you wnat to use spaceline, please comment out junnan-mode-line
    ;; spaceline
    ;; beacon
    ;; evil-vimish-fold
    )
...
(defun junnanzhu-ui/init-junnan-mode-line ()
  (defun junnanzhu/display-mode-indent-width ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (propertize
                          ...
                          'font-lock-type-face))
                 " "
                 '(:eval (junnanzhu/update-persp-name))
                 ...
                 '(:eval (junnanzhu/display-mode-indent-width))
                 ;; line and column
...
(defun junnanzhu-ui/post-init-diminish ()
  (progn
...
(defun junnanzhu-ui/post-init-spaceline ()
...
This segment overrides the modeline functionality of `org-mode-line-string'."
      ...
      (setq-default mode-line-format '("%e" (:eval (spaceline-ml-junnan))))
      )))

(defun junnanzhu-ui/init-beacon ()
  (use-package beacon
    :init
    (progn
...
(defun junnanzhu-ui/init-evil-vimish-fold ()
...
(defun junnanzhu-ui/post-init-hl-anything ()
  (progn
...
(defun junnanzhu-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
(defun junnanzhu-ui/post-init-popwin ()
  (progn
    (push "*junnanzhu/run-current-file output*" popwin:special-display-config)
    (delete "*Async Shell Command*" popwin:special-display-config)))

(defun junnanzhu-ui/post-init-whitespace ()
  (progn
