...
(setq junnanzhu-programming-packages
      '(
        css-mode
        paredit
        lispy
...
(defun junnanzhu-programming/post-init-robe ()
  (progn
    (add-hook 'inf-ruby-mode-hook 'spacemacs/toggle-auto-completion-on)
    (defun junnanzhu/ruby-send-current-line (&optional print)
    ...
    (defun junnanzhu/ruby-send-current-line-and-go ()
      (interactive)
      (junnanzhu/ruby-send-current-line)
      (ruby-switch-to-inf t))

    (defun junnanzhu/start-inf-ruby-and-robe ()
      (interactive)
    ...
    (dolist (mode '(ruby-mode enh-ruby-mode))
      (spacemacs/set-leader-keys-for-major-mode mode
        "sb" 'ruby-send-block
        "sB" 'ruby-send-buffer
        "sl" 'junnanzhu/ruby-send-current-line
        "sL" 'junnanzhu/ruby-send-current-line-and-go
        "sI" 'junnanzhu/start-inf-ruby-and-robe))))

(defun junnanzhu-programming/init-editorconfig ()
  (use-package editorconfig
    :init
    (progn
      (defun conditional-enable-editorconfig ()
        (if (and (junnanzhu/vcs-project-root)
                 (locate-dominating-file default-directory ".editorconfig"))
            (editorconfig-apply)))
      (add-hook 'prog-mode-hook 'conditional-enable-editorconfig))))

(defun junnanzhu-programming/post-init-cider ()
  (setq cider-cljs-lein-repl
        "(do (require 'figwheel-sidecar.repl-api)
           (figwheel-sidecar.repl-api/start-figwheel!)
           (figwheel-sidecar.repl-api/cljs-repl))")

  (defun junnanzhu/cider-figwheel-repl ()
    (interactive)
    (save-some-buffers)
  ...
  (global-set-key (kbd "C-c C-f") #'junnanzhu/cider-figwheel-repl))

(defun junnanzhu-programming/post-init-graphviz-dot-mode ()
  (with-eval-after-load 'graphviz-dot-mode
      (require 'company-keywords)
      (push '(graphviz-dot-mode  "digraph" "node" "shape" "subgraph" "label" "edge" "bgcolor" "style" "record") company-keywords-alist)))

(defun junnanzhu-programming/post-init-dumb-jump ()
...
(defun junnanzhu-programming/post-init-clojure-mode ()
  )

(defun junnanzhu-programming/post-init-emacs-lisp ()
    (remove-hook 'emacs-lisp-mode-hook 'auto-compile-mode))

(defun junnanzhu-programming/post-init-python ()
  (add-hook 'python-mode-hook #'(lambda () (modify-syntax-entry ?_ "w")))
  ;; if you use pyton3, then you could comment the following line
  (setq python-shell-interpreter "python"))

(defun junnanzhu-programming/post-init-js-doc ()
  (setq js-doc-mail-address "junnan.zhu@nlpr.ia.ac.cn"
        js-doc-author (format "Junnan Zhu <%s>" js-doc-mail-address)
        js-doc-url "http://www.junnanzhu.com"
        js-doc-license "MIT")
...
(defun junnanzhu-programming/init-ctags-update ()
...
;; (defun junnanzhu-programming/init-js-comint ()
...
(defun junnanzhu-programming/post-init-web-mode ()
...
(defun junnanzhu-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'junnanzhu/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun junnanzhu-programming/post-init-racket-mode ()
  (progn
...
(defun junnanzhu-programming/post-init-json-mode ()
...
(defun junnanzhu-programming/init-nodejs-repl ()
  (use-package nodejs-repl
    :init
    :defer t))

(defun junnanzhu-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun junnanzhu-programming/init-lispy ()
  (use-package lispy
    :defer t
    :init
    (progn
...
(defun junnanzhu-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun junnanzhu-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun junnanzhu-programming/post-init-cmake-mode ()
  (progn
...
(defun junnanzhu-programming/post-init-flycheck ()
...
(defun junnanzhu-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun junnanzhu-programming/init-impatient-mode ()
  "Initialize impatient mode"
  (use-package impatient-mode
    :init
    (progn
      (add-hook 'web-mode-hook 'junnanzhu/impatient-mode-hook)
...
(defun junnanzhu-programming/post-init-js2-refactor ()
  (progn
    (spacemacs/set-leader-keys-for-major-mode 'js2-mode
      "r>" 'js2r-forward-slurp
      "r<" 'js2r-forward-barf)))

(defun junnanzhu-programming/post-init-js2-mode ()
  (progn
    ...
    (junnanzhu|toggle-company-backends company-tern)

    (spacemacs/set-leader-keys-for-major-mode 'js2-mode
      "tb" 'junnan/company-toggle-company-tern)
...
(defun junnanzhu-programming/post-init-css-mode ()
  (progn
...
(defun junnanzhu-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function junnanzhu/init-<extension-name>
;;
(defun junnanzhu-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun junnanzhu-programming/init-nodejs-repl-eval ()
...
(defun junnanzhu-programming/post-init-lua-mode ()
  (progn
...
(defun junnanzhu-programming/post-init-cc-mode ()
  (progn
...
(defun junnanzhu-programming/init-flycheck-clojure ()
  (use-package flycheck-clojure
    :defer t
    :init
    (eval-after-load 'flycheck '(flycheck-clojure-setup))))

(defun junnanzhu-programming/post-init-ycmd ()
  (progn
    ...
    (junnanzhu|toggle-company-backends company-ycmd)
    (eval-after-load 'ycmd
      '(spacemacs|hide-lighter ycmd-mode))

    (spacemacs/set-leader-keys-for-major-mode 'c-mode
      "tb" 'junnan/company-toggle-company-ycmd)
    (spacemacs/set-leader-keys-for-major-mode 'c++-mode
      "tb" 'junnan/company-toggle-company-ycmd)))

;; when many project has the need to use tags, I will give etags-table and etags-update a try
(defun junnanzhu-programming/init-etags-select ()
...
(defun junnanzhu-programming/init-gulpjs ()
  (use-package gulpjs
    :init
    (progn
      (defun junnan/build-engine ()
        (interactive)
        (gulpjs-start-task-with-file-name "~/Github/fireball/app.js"))

      (spacemacs/set-leader-keys "ags" 'gulpjs-start-task)
      (spacemacs/set-leader-keys "agS" 'junnan/build-engine)
      (spacemacs/set-leader-keys "agr" 'gulpjs-restart-task))))


(defun junnanzhu-programming/init-paredit ()
  (use-package paredit
...
(defun junnanzhu-programming/post-init-company ()
  (progn
...
(defun junnanzhu-programming/post-init-company-c-headers ()
  (progn
