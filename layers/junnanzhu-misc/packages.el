...
(defun junnanzhu-misc/init-highlight-global ()
...
(defun junnanzhu-misc/post-init-ranger ()
...
(defun junnanzhu-misc/init-helm-ag ()
  (use-package helm-ag
    :defer t
    :init
    (progn
...
(defun junnanzhu-misc/post-init-gist ()
  (use-package gist
    :defer t
    :init
...
(defun junnanzhu-misc/init-peep-dired ()
...
(defun junnanzhu-misc/post-init-flyspell-correct ()
  (progn
    (with-eval-after-load 'flyspell
      (define-key flyspell-mode-map (kbd "C-;") 'flyspell-correct-previous-word-generic))
    (setq flyspell-correct-interface 'flyspell-correct-ivy)))

(defun junnanzhu-misc/post-init-smartparens ()
...
(defun junnanzhu-misc/init-tiny ()
  (use-package tiny
    :defer t
    :init
    (spacemacs/set-leader-keys "oe" 'tiny-expand)))

(defun junnanzhu-misc/post-init-helm ()
...
(defun junnanzhu-misc/init-helm-github-stars ()
  (use-package helm-github-stars
    :commands (helm-github-stars)
    :init
    (setq helm-github-stars-username "junnanzhu")))




(defun junnanzhu-misc/post-init-fcitx ()
  (fcitx-aggressive-setup))

(defun junnanzhu-misc/post-init-command-log ()
...
(defun junnanzhu-misc/init-litable ()
  (use-package litable
    :init
    :defer t))

(defun junnanzhu-misc/init-osx-dictionary ()
...
(defun junnanzhu-misc/init-4clojure ()
...
(defun junnanzhu-misc/post-init-avy ()
  (progn
    (global-set-key (kbd "C-s-'") 'avy-goto-char-2)
    (global-set-key (kbd "M-'") 'avy-goto-char-2)))

(defun junnanzhu-misc/post-init-ace-window ()
  (global-set-key (kbd "C-x C-o") #'ace-window))

(defun junnanzhu-misc/init-discover-my-major ()
...
(defun junnanzhu-misc/post-init-elfeed ()
  (use-package elfeed
    :init
    ...
    (progn
      ...
      (defun junnan/elfeed-mark-all-as-read ()
        (interactive)
        (mark-whole-buffer)
        (elfeed-search-untag-all-unread))

      (define-key elfeed-search-mode-map (kbd "R") 'junnan/elfeed-mark-all-as-read)
...
(defun junnanzhu-misc/post-init-evil ()
  (progn
    ...
    (define-key evil-normal-state-map
      (kbd "Y") 'junnanzhu/yank-to-end-of-line)
    ...
    (define-key evil-visual-state-map (kbd "C-r") 'junnanzhu/evil-quick-replace)
    ...
    ;; (defadvice evil-insert-state (around junnanzhu/holy-mode activate)
...
(defun junnanzhu-misc/init-visual-regexp ()
  (use-package visual-regexp
    :commands (vr/replace vr/query-replace)))

(defun junnanzhu-misc/init-visual-regexp-steroids ()
...
(defun junnanzhu-misc/init-multiple-cursors ()
...
;;; Occasionally useful
    ...
    (setq mc/cmds-to-run-once
          '(
            counsel-M-x
            junnanzhu/my-mc-mark-next-like-this))
...
(defun junnanzhu-misc/post-init-persp-mode ()
...
(defun junnanzhu-misc/post-init-chinese-wbim ()
  (progn
...
(defun junnanzhu-misc/post-init-evil-escape ()
  (setq evil-escape-delay 0.2))

(defun junnanzhu-misc/init-find-file-in-project ()
...
(defun junnanzhu-misc/post-init-projectile ()
  (progn
  ...
  current project. Otherwise do `occur' in the current file."
    ...
    (spacemacs/set-leader-keys "pf" 'junnanzhu/open-file-with-projectile-or-counsel-git)
    (spacemacs/set-leader-keys "pt" 'my-simple-todo)))



(defun junnanzhu-misc/post-init-prodigy ()
  (progn
    (prodigy-define-tag
      :name 'jekyll
...
(defun junnanzhu-misc/init-moz-controller ()
...
(defun junnanzhu-misc/init-ag ()
  (use-package ag
    :init))

(defun junnanzhu-misc/post-init-erc ()
  (progn
    (add-hook 'erc-text-matched-hook 'my-erc-hook)
    (spaceline-toggle-erc-track-off)))

(defun junnanzhu-misc/init-wrap-region ()
...
(defun junnanzhu-misc/init-keyfreq ()
  (use-package keyfreq
    :init
    (progn
      (keyfreq-mode t)
...
(defun junnanzhu-misc/post-init-swiper ()
...
(defun junnanzhu-misc/post-init-magit ()
  (progn
    ...
    (eval-after-load 'magit
      '(define-key magit-mode-map (kbd "C-c g")
         #'junnanzhu/magit-visit-pull-request))

    (setq magit-process-popup-time 10)))

(defun junnanzhu-misc/post-init-git-messenger ()
  (use-package git-messenger
    :defer t
    :config
    (progn
      (define-key git-messenger-map (kbd "f") 'junnan/github-browse-commit))))

(defun junnanzhu-misc/post-init-markdown-mode ()
  (progn
